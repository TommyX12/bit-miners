...
public class Biome
{
    ...
    public Dictionary<string, float> EnemySpawnTypeChance = new Dictionary<string, float>();
    public Dictionary<int, float> EnemySpawnNumberChance = new Dictionary<int, float>();
    ...
    private static Dictionary<string, Biome> biomeDict = new Dictionary<string, Biome>() {
        {"tundra", new Biome(){
            ...
            EnemySpawnTypeChance = new Dictionary<string, float>() {
                {"nothing", 1000f},
            },
            EnemySpawnNumberChance = new Dictionary<int, float>() {
                {0, 100f},
                {1, 10f},
                {2, 1f},
            },
